...
def init_project_graph(
    storage_dir: str = "graphs", use_db: bool = True, repository: GraphRepository = None
):
    """
    ...
    # Filosofía
    phil = NodeData(
        id="philosophy", type=NodeType.CONCEPT, content="GRAFO, PYTHON, API, DOC, TEST."
    )
    ...
    roles_specs = [
        ...
        (
            "role_ing_frontend_int",
            "Ingeniero Frontend Integración",
            "integracion ui backend",
        ),
        ("role_ing_datos", "Ingeniero de Datos", "modelo de datos y persistencia"),
        (
            "role_ing_grafos",
            "Ingeniero de Grafos",
            "relaciones complejas y conocimiento conectado",
        ),
        (
            "role_ing_ia_sistemas",
            "Ingeniero IA Sistemas",
            "comportamiento, memoria, contexto y control de IA",
        ),
        ("role_ing_ia_int", "Ingeniero IA Integración", "integración de modelos IA"),
        (
            "role_ing_seguridad",
            "Ingeniero Seguridad",
            "seguridad end-to-end y cumplimiento",
        ),
