...
def backup_database(
    db_path: str = "data/graph.db", backup_dir: str = "data/backups"
) -> str:
...
def export_to_json(
    db_path: str = "data/graph.db", output_path: str = "graphs/export.json"
):
...
def import_from_json(
    json_path: str, db_path: str = "data/graph.db", clear_existing: bool = False
):
